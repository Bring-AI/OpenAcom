  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        desktop: { type: 'boolean', description: "zcode only. Default (omitted): CDP delivery when the desktop app runs with --remote-debugging-port, headless otherwise. true = force UI delivery (CDP, UIA fallback), false = always headless. UI delivery = live refresh + steer, no reply text." },
...
function sendMessage(args) {
  ...
  else if (args.desktop === false) opts.desktop = false; // undefined = auto (CDP preferred for zcode)
  if (args.fresh) {
