  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        desktop: { type: 'boolean', description: 'zcode only, default false. true = deliver through the desktop UI via CDP: live refresh and steer of a running turn, but the app briefly switches to that conversation and no reply text is returned. Omit for silent headless delivery.' },
...
function sendMessage(args) {
  ...
  if (args.desktop === true) opts.desktop = true; // default (omitted) = headless, no UI switch
  if (args.fresh) {
