...
// desktop option: true = deliver through the desktop UI via CDP (live refresh
// + steer, but the app briefly switches to that conversation), false/undefined
// (default) = headless: zero UI involvement, no view switch.
